$(document).ready(function() {
    ...
    $('.proje-prev').click(function(){
        $('.slider-projeler').slick('slickPrev');
    })

    $('.proje-next').click(function(){
        $('.slider-projeler').slick('slickNext');
    })

    $('.referans-prev').click(function(){
        $('.slider-referans').slick('slickPrev');
    })

    $('.referans-next').click(function(){
        $('.slider-referans').slick('slickNext');
    })
